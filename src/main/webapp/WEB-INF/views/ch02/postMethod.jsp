		...
		<div class="card-body">
			<form method="post" action="postFormTag">
				<div class="mb-3">
					...
					<br />
					<%--  제출 버튼을 만드는 방법3: form 태그 안의 button 태그 --%>
					<%-- type: default값이 submit --%>
						...
						$.ajax({
							...
							success: function(data) {
								...
								data.data.forEach(function(item) {
										content +=
									"<img height='100' src='${pageContext.request.contextPath}/resources/image/photos/" + item + "' class='me-2' />"
								});
								content += "	</div>";
								content += "</div>"
